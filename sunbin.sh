...
show_usage() {
    echo -e "┌───────────────────────────────────────────────────────┐
│  ${blue}x-ui 控制命令使用说明 (子命令):${plain}                     │
│                                                       │
│  ${blue}x-ui${plain}              - 主管理脚本                     │
...
│  ${green}19.${plain} Cloudflare证书配置                       │
│  ${green}20.${plain} IP访问限制                               │
│  ${green}21.${plain} 防火墙配置                               │
│  ${green}22.${plain} SSH端口转发管理                          │
│────────────────────────────────────────────────│
│  ${green}23.${plain} 启用BBR加速                              │
│  ${green}24.${plain} 更新GeoIP数据库                          │
│  ${green}25.${plain} Ookla网速测试                            │
╚────────────────────────────────────────────────╝
"
    show_status
